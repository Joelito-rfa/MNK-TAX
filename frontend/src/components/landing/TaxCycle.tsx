        ...
        <div className="hidden lg:flex items-center justify-center gap-2">
          {steps.map((step, i) => (
            <div key={step.label} className="flex items-center gap-2">
              <div className="group relative rounded-2xl border border-white/[0.06] bg-white/[0.03] p-5 text-center transition-all duration-300 hover:border-brand-500/20 hover:bg-white/[0.06] hover:shadow-lg hover:shadow-brand-500/5 w-32">
        ...
        <div className="lg:hidden flex flex-col items-center gap-1">
          {steps.map((step, i) => (
            <div key={step.label} className="flex flex-col items-center">
              <div className="flex items-center gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 w-full max-w-xs transition-all duration-300 hover:border-brand-500/20">
