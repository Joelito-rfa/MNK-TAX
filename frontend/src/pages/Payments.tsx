...
import { Download, Eye, Plus, X, Ban, Search, Filter } from 'lucide-react'
import { apiErrorMessage, apiGet, apiPost, apiPut } from '../lib/api'
import { fmtDate, fmtDateTime, fmtMGA } from '../lib/format'
import { downloadCsv } from '../lib/csv'
import type { Page, Payment, PaymentAllocationDto, TaxDebt, TaxType } from '../types'
...
export default function Payments() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Paiements"
        subtitle="Module d'encaissement fiscal — suivi, allocation et quittances"
        actions={
...
function CreatePaymentModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal open onClose={onClose} title="Nouveau paiement" subtitle="Le montant est alloué automatiquement sur la créance choisie.">
      <form
        onSubmit={(e) => {
          e.preventDefault()
          create.mutate({
